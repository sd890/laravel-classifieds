...
<body class="error-page" style="background-color: #cfb3bcff;">
<div class="m-4 card">
    <div class="card-body ">
        <div class="text-center row justify-content-md-center">
            ...
            <div dir="ltr" class="col-12">
                <h4 class="text-center display-5 w-100 text-danger font-weight-bold">سایت دیوار</h4>
            </div>
            <div class="mt-4 col-12">
                <a href="{{route('home')}}" id="callback-link">
